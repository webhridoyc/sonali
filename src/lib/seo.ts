  ...
  hasOfferCatalog: {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        itemOffered: {
          '@type': 'Service',
          name: 'Monthly DPS (Deposit Pension Scheme)',
          description: 'Monthly deposit scheme with guaranteed returns and flexible terms'
        }
      },
      {
        '@type': 'Offer',
        itemOffered: {
          '@type': 'Service',
          name: 'FDR (Fixed Deposit Return)',
          description: 'Fixed deposit schemes with attractive interest rates and secure returns'
        }
      },
      {
        '@type': 'Offer',
        itemOffered: {
          ...
          description: 'Convenient daily savings program for regular contributions'
        }
      },
      {
        '@type': 'Offer',
        itemOffered: {
          '@type': 'Service',
          name: 'Personal Loan',
          description: 'Easy personal loans with low interest rates and quick approval'
        }
      },
      {
        '@type': 'Offer',
