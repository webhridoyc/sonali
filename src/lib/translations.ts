export const translations = {
  ...
  memberPortal: {
    ...
    submitSuccessDesc: { en: 'Thank you. We have received your application and will be in touch soon.', bn: 'ধন্যবাদ। আমরা আপনার আবেদন পেয়েছি এবং শীঘ্রই যোগাযোগ করব।' },
    submitError: { en: 'Submission Failed', bn: 'জমা ব্যর্থ হয়েছে' },
    submitErrorDesc: { en: 'Please try again later.', bn: 'অনুগ্রহ করে পরে আবার চেষ্টা করুন।' },
  },
  contact: {
