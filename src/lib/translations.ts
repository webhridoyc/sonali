export const translations = {
  ...
  memberPortal: {
    ...
    joinDesc: { en: 'Interested in becoming a part of our community? Fill out the form below and we will contact you shortly.', bn: 'আমাদের সম্প্রদায়ের অংশ হতে আগ্রহী? নিচের ফর্মটি পূরণ করুন এবং আমরা শীঘ্রই আপনার সাথে যোগাযোগ করব।' },
